...
# Third step: Call the readFile() function and count all "e"s and "E"s contained in the file using the count() method. 
# References used: 
...
contents = readFile()                                       # stores the content of the file accessed in readFile() function in a variable called "contents"
